                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  users ORDER BY user_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            $no++; ?>
                                            <tr>
                                                <td><?php print($no) ?></td>
                                                <td><?php print($data["user_fname"]); ?></td>
                                                <td><?php print($data["user_lname"]) ?></td>
                                                <td><?php print($data["user_phone"]) ?></td>
                                                <td><?php print($data["user_email"]) ?></td>
                                                <td><?php print($data["user_password"]) ?></td>
                                                <td><?php print($data["user_role"]) ?></td>
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="?deleteUser=<?php print($data["user_id"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
