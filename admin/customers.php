                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  customers, districts WHERE districts.district_id = customers.district_id  ORDER BY customer_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php print($data["customer_lname"]) ?></td>
                                                <td><?php print($data["customer_phone"]) ?></td>
                                                <td><?php print($data["customer_email"]) ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#=<?php print($data["customer_id"]); ?>">Orders</a>
                                                            <a class="dropdown-item" href="?deletecustomer=<?php print($data["customer_id"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
