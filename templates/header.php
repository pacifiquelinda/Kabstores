                ...
                <div class="col-xxl-4 col-lg-4">
                    <div class="top-left-3 d-inline-block">
                        <div class="header-contact-3">
                            <a href=""><i class="fal fa-headphones-alt"></i> +250 788 458 897</a>
                        </div>
                    </div>
                    <div class="select-boxes select-boxes-3">
                        <div class="select-default select-default-3">
                            <button><a href="https://www.instagram.com/kabstore_rw/" target="_blank"><i class="fab fa-instagram" style="font-size:20px"></i></a></button>

                        </div>
                        <div class="select-default ml-10">
                            <!-- <button><i class="fab fa-twitter" style="font-size:20px"></i></button> -->
                        </div>
                    </div>
                </div>
                <!-- <div class="col-xl-8  col-lg-8">
                    <div class="header-right-3 text-end">
                        <div class="h-top-list-3 d-inline-block">
                            <a href="register"><i class="fal fa-user"></i>Log in / Register </a>
                            <a href="single-product"><i class="fal fa-balance-scale"></i>Compare</a>
                            <a href="cart"><i class="fal fa-heart"></i>Wishlist</a>
                            <a href="cart" class="header-cart-3"><i class="fal fa-shopping-bag"></i>0 / 0.00 RWF</a>
                        </div>
                    </div>
                </div> -->
    ...
    <div class="header-main-3 p-rel">
        <div class="container">
            <div class="header-wrap-3">
                <div class="logo">
                    <a href="./"><img src="assets/img/logo/logo-black.PNG" alt="" width="200"></a>
                </div>
