...
<head>
    ...
    <title>Welcome to KABSTORE </title>
                ...
                <div class="row align-items-center mb-80 category-row-space-3">
                    <div class="col-xxl-3 col-md-5">
                        <div class="epix-section-title-4">
                            ...
                            <p>KABSTORE is World’s largest otd online<br>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab1">
                            <div class="swiper-container tab-product-active">
                                <div class="swiper-wrapper">
                                    <?php
                                    $query = mysqli_query($connection, "SELECT * FROM products, categories, products_categories WHERE products_categories.product_id = products.product_id AND products_categories.category_id = categories.category_id ORDER BY rand() LIMIT 4") or die(mysqli_error($connection));
                                        ...
                                        <div class="swiper-slide">
                                            <div class="single-product-4">
                                                <div class="product-top">
                                                    <div class="wrap">
                                                        <span class="epix-p-subtitle"><?php print $product["category_name"]; ?></span>
                                                        <div class="actions">
                                                            <a href="product?details=<?php print $product["product_id"]; ?>"><i class="fal fa-compress-alt"></i></a>
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <a href="product?details=<?php print $product["product_id"]; ?>"> <img src="<?php print $product["product_image"]; ?>" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="content">
                                                    <h4><a href="product?details=<?php print $product["product_id"]; ?>"><?php print $product["product_name"]; ?></a></h4>
                                                    <div class="price-box">
                ...
                <div class="offer-banner-2-content pt-60 pb-35">
                    ...
                    <div class="offer-product-content">
                        <div class="wrap">
                            ...
                            <h3 class="title"><a href="product?details=<?php print $product["product_id"]; ?>">Denon AH-D7100 Music Maniac <br>
                                    Headphones</a></h3>
                            <div class="price-box">
                ...
                <div class="row">
                    <div class="col-xxl-3 col-lg-3 trending-col-1">
                        <div class="trending-banner">
                            <a href="shop"><img src="assets/img/banner/trending-banner.jpg" class="img-fluid" alt=""></a>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div class="product-tabs-2">
                                        <ul class="nav justify-content-md-end" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="active" data-bs-toggle="tab" data-bs-target="#tab-1-1" type="button">On Sell</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="" data-bs-toggle="tab" data-bs-target="#tab-1-2" type="button" role="tab">Htot Sell</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="" data-bs-toggle="tab" data-bs-target="#tab-1-3" type="button">Trend</button>
                                            </li>
                                            <li class="nav-item" role="presentation">

                                                <button class="" data-bs-toggle="tab" data-bs-target="#tab-1-4" type="button">Best Sell</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-6 col-xl-6">
                        <div class="subscribe-wrap">
                            ...
                            <div class="d-block text-center">
                                ...
                                <div class="hint">
                                    <p>Will be used in accordance with our <a href="contact">Privacy Policy</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="contact"><img src="assets/img/brand/brand2/brand.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="shop"><img src="assets/img/brand/brand2/brand2.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="shop"><img src="assets/img/brand/brand2/brand3.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="shop"><img src="assets/img/brand/brand2/brand4.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="shop"><img src="assets/img/brand/brand2/brand5.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xxl-4 col-6 col-md-4">
                                    <div class="brand-logo mb-55">
                                        <a href="shop"><img src="assets/img/brand/brand2/brand6.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
